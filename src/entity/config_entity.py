...
training_pipe_config: TrainingPipelineConfig = TrainingPipelineConfig()

@dataclass

class DataIngestionConfig:
    data_ingestion_dir: str =os.path.join(training_pipe_config.artifact_dir,DATA_INGESTION_DIR_NAME)
    feature_store_file_path:str=os.path.join(ARTIFACT_DIR,TIMESTAMP,FILE_NAME)
...
class DataValidationConfig:
    data_validation_dir=os.path.join(training_pipe_config.artifact_dir,DATA_VALIDATION_DIR_NAME)
    validation_report_file_path :str=os.path.join(data_validation_dir,DATA_VALIDATION_REPORT_FILE_NAME)
    

@dataclass
class DataTransformationConfig:
    data_transformation_dir:str=os.path.join(training_pipe_config.artifact_dir,DATA_TRANSFORMATION_DIR_NAME)
...
class ModelTrainerConfig:
    model_trainer_dir:str=os.path.join(training_pipe_config.artifact_dir,MODEL_TRAINER_DIR_NAME)
